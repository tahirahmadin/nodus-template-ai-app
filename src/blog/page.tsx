...
export default function BlogsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>
          All blogs | Minimal Portfolio Website Template - Aceternity UI Pro
        </title>
        <meta
          name="description"
          content="A perfect portfolio website template that showcases your skills, minimal and smooth microinteractions, perfect for developers and designers."
        />
      </Helmet>
      <div>
        <DivideX />
