      ...
      <Helmet>
        ...
        {seoData.openGraph && (
          <>
            ...
            {seoData.openGraph.images && seoData.openGraph.images[0] && (
        ...
        {seoData.twitter && (
          <>
            ...
            {seoData.twitter.images && seoData.twitter.images[0] && (
              <meta name="twitter:image" content={seoData.twitter.images[0].url} />
            )}
          </>
        )}
      </Helmet>
